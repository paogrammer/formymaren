...
const OTPInputGroup = () => {
    ...
    const handleSubmit = () => {
        ...
        const enteredPassword = `${inputValues.input1}${inputValues.input2}${inputValues.input3}${inputValues.input4}`;
        const correctPassword = "1218";

        if (enteredPassword === correctPassword) {
            // Navigate to the "/greeting" page if the password is correct
            window.location.href = "/greeting";
        } else {
            // Display a message for wrong password
